...
public enum ActionType {
    ...
    // locationKeyword：可选区域/位置限定词（如"东门"），只操作该区域在线路灯；不传则操作全部在线路灯
    TURN_OFF_ALL("关闭全部设备", ActionRisk.LOW_WRITE, true, Set.of("locationKeyword")),
    TURN_ON_ALL("打开全部设备", ActionRisk.LOW_WRITE, true, Set.of("locationKeyword")),
